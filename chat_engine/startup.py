...
from chat_engine.configuration import TECHSTAFF_DB_DIR, GENERAL_DB_DIR, DIRECTORIES_GENERAL, DIRECTORIES_TECHSTAFF
...
def startup_routine():
    ...
    try:
        ...
        initialize_documents(general_data_dir, DIRECTORIES_GENERAL, os.getenv("DOCHUB_USERNAME_GENERAL"), os.getenv("DOCHUB_PASSWORD_GENERAL"))
        # initialize_documents(techstaff_data_dir, DIRECTORIES_TECHSTAFF, os.getenv("DOCHUB_USERNAME_STAFF"), os.getenv("DOCHUB_PASSWORD_STAFF"))
